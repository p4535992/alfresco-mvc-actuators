 ...
 * {@link HealthComponent} so that additional contextual details about the
 * system can be returned along with the {@link Status}.
 * <p>
...
public final class Health extends HealthComponent {
	...
	/**
	 * Return a new instance of this {@link Health} with all {@link #getDetails()
	 * details} removed.
	 * 
	...
	/**
	 * Create a new {@link Builder} instance with an {@link Status#DOWN} status and
	 * the specified exception details.
	 * 
	...
	/**
	 * Create a new {@link Builder} instance with an {@link Status#OUT_OF_SERVICE}
	 * status.
	 * 
	 * @return a new {@link Builder} instance
	 */
	...
	public static class Builder {
		...
		/**
		 * Create new Builder instance, setting status to given {@code status} and
		 * details to given {@code details}.
		 * 
		 * @param status  the {@link Status} to use
